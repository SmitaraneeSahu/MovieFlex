...
export default function useFetch(apiPath, queryTerm="", deps = []) {
  ...
  const url = `https://api.themoviedb.org/3/${apiPath}?api_key=${API_KEY}&with_original_language=hi&release_date.lte=2025-11-01&sort_by=release_date.desc&page=${page}&query=${queryTerm}`
